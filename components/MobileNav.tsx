          ...
          <div className="mt-16 space-y-4">
            {navItems.map((item) => (
              <a
                ...
                className="flex items-center gap-3 px-4 py-3 text-foreground-muted hover:text-primary hover:bg-background-tertiary rounded-xl transition-colors duration-300 ease-smooth group"
              >
          ...
          <div className="mt-8 pt-8 border-t border-card-border">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="p-2.5 bg-background-tertiary rounded-xl hover:bg-primary/20 transition-colors duration-300 ease-smooth focus:outline-none focus:ring-2 focus:ring-primary/50"
              >
